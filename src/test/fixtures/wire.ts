...
import deckJson from '@contracts/fixtures/deck.json';
import editableJson from '@contracts/fixtures/editable.json';
import gateBootJson from '@contracts/fixtures/gate.boot.json';
import inviteJson from '@contracts/fixtures/invite.json';
import exportAnonymizeJson from '@contracts/fixtures/export.anonymize.json';
import exportPerformanceJson from '@contracts/fixtures/export.performance.json';
import exportPlanJson from '@contracts/fixtures/export.plan.json';
import exportPokerJson from '@contracts/fixtures/export.poker.json';
import exportProfileJson from '@contracts/fixtures/export.profile.json';
import exportReportingJson from '@contracts/fixtures/export.reporting.json';
import exportRetroJson from '@contracts/fixtures/export.retro.json';
import exportRoadmapJson from '@contracts/fixtures/export.roadmap.json';
import exportStandupJson from '@contracts/fixtures/export.standup.json';
import pokerBootJson from '@contracts/fixtures/poker.boot.json';
import pokerDuelJson from '@contracts/fixtures/poker.duel.json';
import pokerRevealedJson from '@contracts/fixtures/poker.revealed.json';
import pokerVotingJson from '@contracts/fixtures/poker.voting.json';
import retroBootJson from '@contracts/fixtures/retro.boot.json';
import retroJson from '@contracts/fixtures/retro.json';
import shipJson from '@contracts/fixtures/ship.json';
import ticketPeekJson from '@contracts/fixtures/ticket.peek.json';
