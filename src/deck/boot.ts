...
export interface DeckBoot {
  /**
   * The shared page furniture. The deck draws only the footer from it — a
   * slide deck's title slide already is a masthead, and a terminal frame on a
   * projector would be absurd — but taking the credit from here is what stops
   * it being the one "Generated by yeaboi" of ten that lived in TSX and could
